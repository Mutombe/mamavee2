...
const Content = () => {
  ...
  const filters = ['All', 'Skits', 'Vlogs', 'Collaborations', 'Behind the Scenes'];
  ...
  const videos = [
    ...
    {
      id: 2,
      title: "Cooking with Mama Vee - Ep 1",
      category: "Vlogs",
      views: "850K",
      duration: "12:15",
    ...
    {
      id: 5,
      title: "Pranking My Neighbors",
      category: "Skits",
      views: "1.8M",
      duration: "6:10",
      thumbnail: "https://images.unsplash.com/photo-1520223297774-89544089831d?q=80&w=1000&auto=format&fit=crop"
    },
    {
      id: 6,
      ...
      <section className="py-20 bg-dark-800 border-b border-white/5">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg">
            Dive into the world of laughter. From viral skits to intimate vlogs, watch it all here.
          </p>
        </div>
      </section>
            ...
            >
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-2">
                  <span className="text-gold-500 text-xs font-bold uppercase tracking-wider">{video.category}</span>
      ...
      <section className="py-20 bg-gradient-to-b from-dark-800 to-dark-900">
        <div className="container mx-auto px-6">
          <div className="flex justify-between items-end mb-12">
            <div>
              <h2 className="text-gold-500 font-medium tracking-widest mb-2 uppercase">Featured Series</h2>
              <h3 className="text-3xl md:text-4xl font-heading font-bold text-white">The Chronicles of Mama Vee</h3>
            </div>
          </div>
          
          <div className="relative rounded-2xl overflow-hidden aspect-[21/9] group cursor-pointer">
            <img 
              src="https://images.unsplash.com/photo-1517604931442-71053e3e2e3c?q=80&w=2000&auto=format&fit=crop" 
              alt="Featured Series" 
            ...
            <div className="absolute bottom-0 left-0 p-8 md:p-12 w-full md:w-2/3">
              <span className="px-4 py-2 bg-gold-500 text-dark-900 font-bold rounded-full text-sm mb-4 inline-block">
                Season Finale
              </span>
              ...
              <p className="text-gray-300 text-lg mb-8 line-clamp-2">
                Watch the hilarious conclusion to the summer series where the entire extended family comes to visit. Chaos ensues!
              </p>
              <button className="px-8 py-3 bg-white text-dark-900 font-bold rounded-full hover:bg-gray-200 transition-colors flex items-center gap-2">
